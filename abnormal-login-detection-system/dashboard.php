...
<div class="dashboard-wrapper">
    ...
    <div class="card-grid">
        ...
        <div class="card">
            ...
            <p>Xem danh sách người dùng và quản lý thông tin tài khoản.</p>
        ...
        <div class="card">
            ...
            <p>Theo dõi đăng nhập, phát hiện Brute Force, chặn IP và xem log.</p>
        ...
        <div class="card">
            ...
            <p>Đổi mật khẩu và bảo vệ tài khoản bằng cơ chế mã hóa mật khẩu.</p>
